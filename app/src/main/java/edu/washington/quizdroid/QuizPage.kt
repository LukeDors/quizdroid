    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        next.setOnClickListener {
            ...
            if ((count % 2) == 1) {
                ...
                val answer = id.text
                Log.d("answer", topic.questions[questionIndex-1].options[topic.questions[questionIndex-1].answer])
                if (answer.toString() == topic.questions[questionIndex-1].options[topic.questions[questionIndex-1].answer]) {
                    correct += 1
                }
